...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_audio_wing_flap_mp3 extends flash.media.Sound { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_textures_1x_compressed_texture_atf extends flash.utils.ByteArray { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_fonts_1x_desyrel_fnt extends flash.utils.ByteArray { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_fonts_dejavusans_ttf extends flash.text.Font { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_fonts_ubuntu_r_ttf extends flash.text.Font { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__manifest_default_json extends flash.utils.ByteArray { }


#elseif (desktop || cpp)

@:keep @:font("assets/fonts/DejaVuSans.ttf") @:noCompletion #if display private #end class __ASSET__assets_fonts_dejavusans_ttf extends lime.text.Font {}
@:keep @:font("assets/fonts/Ubuntu-R.ttf") @:noCompletion #if display private #end class __ASSET__assets_fonts_ubuntu_r_ttf extends lime.text.Font {}
...
#if html5
@:keep @:expose('__ASSET__OPENFL__assets_fonts_dejavusans_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_dejavusans_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__assets_fonts_dejavusans_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_fonts_ubuntu_r_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_ubuntu_r_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__assets_fonts_ubuntu_r_ttf ()); super (); }}
