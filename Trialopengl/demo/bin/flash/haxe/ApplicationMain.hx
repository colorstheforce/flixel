...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Demo", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Demo", null, 320, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Demo";
		app.meta["name"] = "Starling Demo";
		app.meta["packageName"] = "com.gamua.starling.demo";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("Demo")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess Demo.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"Demo\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"Demo\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends Demo {}
#else
class DocumentClass
{
